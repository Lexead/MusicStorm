<section class="tracks-section">
    <div class="tracks-container">
        ...
        <div class="track-list" data-aos="fade-down-left">
            <?php 
                ...
                if (mysqli_num_rows($check_tracks) > 0) {
                    ...
                    $i = 0;
                    foreach (get_query($link, $query . " LIMIT 3") as $track) { 
            ...
            ?>
                        <div class="track-item">
                            <span class="track-status"><?php echo $i?></span>
        ...
        <?php
            if(mysqli_num_rows($check_tracks) > 3) {
        ?>
                <a href="../tracks" class="see-all" data-aos="fade-down-left">See all</a>
        <?php
            }
        ?>
    </div>
